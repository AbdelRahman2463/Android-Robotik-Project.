...
|------|-------------|------------|
| **Manual Control** | Real-time robot navigation via a virtual joystick interface | Bluetooth Serial |
| **Autonomous Tracking** | Automatic object following (Line or Ball) using the phone's camera | CameraX + Computer Vision |
...
See [`docs/FinalReport.pdf`](docs/FinalReport.pdf) for the complete project report and technical specifications.
